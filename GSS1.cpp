//blueocean-penn.blogspot.in taken from
//concept used is
//2....................10
//<.....prefixmaxsum..
//2.........6.7..........10
//<prefixmaxsum><prefixmaxsum>
//<...sum..>
// prefixmaxsum(2,10)=max(prefixmaxsum(2,6),sum(2,6)+prefixsum(7,10)
//we can do suffixmaxsum similar manner
...
int main() {
	...
	for (i = 0; i < M; ++i) {
		scanf("%d %d", &x, &y);
		printf("%d\n", st.getValue(x-1, y-1));// in question it stARTS WITH A[1]
	}
